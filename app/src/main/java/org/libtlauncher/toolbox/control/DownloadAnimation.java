...
public class DownloadAnimation extends View {

    private static final int BLUE_ONE = Color.parseColor("#FFCDECFE");
    private static final int WHILE = Color.parseColor("#FF31A1F8");
    ...
    public DownloadAnimation(Context context) {
        this(context, null);
    }

    public DownloadAnimation(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DownloadAnimation(Context context, AttributeSet attrs, int defStyleAttr) {
